            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    ...
                    <ul class="list-unstyled list-inline mb-7 mb-md-0 text-gray-350">
                        <li class="list-inline-item">
                            <a href="index-fashion.html#!" class="text-reset">
                ...
                <div class="col-6 col-sm">
                    ...
                    <ul class="list-unstyled mb-7 mb-sm-0">
                        ...
                        <li>
                            <a class="text-gray-300" data-toggle="modal" href="index-fashion.html#modalSizeChart">Size Guide</a>
                        </li>
                        <li>
                ...
                <div class="col-6 col-sm">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li>
                            <a class="text-gray-300" href="index-fashion.html#!">Careers</a>
                        </li>
                        <li>
                            <a class="text-gray-300" href="index-fashion.html#!">Terms & Conditions</a>
                        </li>
                        <li>
                            <a class="text-gray-300" href="index-fashion.html#!">Privacy & Cookie policy</a>
                        </li>
                    </ul>
                ...
                <div class="col-6 col-sm">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <a class="text-gray-300" href="index-fashion.html#!">1-202-555-0105</a>
                        </li>
                        <li>
                            <a class="text-gray-300" href="index-fashion.html#!">1-202-555-0106</a>
                        </li>
                        <li>
                            <a class="text-gray-300" href="index-fashion.html#!">help@shopper.com</a>
                        </li>
                    </ul>
