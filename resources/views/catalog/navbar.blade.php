        ...
        <div class="collapse navbar-collapse" id="navbarFashionBottomCollapse">
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <!-- Toggle -->
                    <a class="nav-link" data-toggle="dropdown" href="index-fashion.html#">Одежда</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <!-- Toggle -->
                    <a class="nav-link" data-toggle="dropdown" href="index-fashion.html#">Верхняя одежда</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <!-- Toggle -->
                    <a class="nav-link" data-toggle="dropdown" href="index-fashion.html#">Головные уборы</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <!-- Toggle -->
                    <a class="nav-link" data-toggle="dropdown" href="index-fashion.html#">Аксессуары</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <!-- Toggle -->
                    <a class="nav-link" data-toggle="dropdown" href="index-fashion.html#">Коверты/Пледы</a>
