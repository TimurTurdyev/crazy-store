...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/plugins/colorbox-master/example1/colorbox.css') }}">
</head>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('customer.orders') }}" class="nav-link">Лк пользователя</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="{{ route('admin.dashboard') }}" class="brand-link">
            <img src="{{ asset('admin/dist/img/AdminLTELogo.png') }}" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Crazy Kids</span>
        </a>
        <div class="sidebar">
            <nav class="mt-2">
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">@yield('header', 'Панель администратора')</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">На главную</a></li>
                            @yield('breadcrumbs')
                        </ol>
                    </div>
                </div>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2021 <a href="https://github.com/TimurTurdyev" target="_blank">Timur Turdyev</a>.</strong>
        All rights reserved.
        <div class="float-right d-none d-sm-inline-block">
            <b>Version</b> 3.1.0 / Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
        </div>
    </footer>
...
<script src="{{ asset('admin/plugins/colorbox-master/jquery.colorbox-min.js') }}"></script>
@stack('scripts')
